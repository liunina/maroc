...
- (void)registerModulesByURLs {
    ...
    [router addPathComponent:orderPathComponentKey
                    forClass:[MCOrderService class]
                     handler:^(Protocol *_Nonnull protocol, SEL _Nullable selector, NSDictionary<NSString *, id> *_Nonnull params) {
